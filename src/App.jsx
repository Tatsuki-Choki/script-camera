            ...
            <div className="flex items-center gap-4">
                {!isRecording ? (
                     <button 
                        ...
                        className={`flex items-center gap-3 px-8 py-4 rounded-full font-bold text-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all ${
                            cameraActive 
